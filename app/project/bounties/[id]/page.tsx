    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                if (bountyError || !bountyData) throw new Error("Bounty not found");

                if (bountyData.user_id !== user.id) {
    ...
    const updateStatus = async (submissionId: string, status: "approved" | "rejected") => {
        try {
            ...
            setModalState({
                isOpen: true,
                type: "success",
                title: status === "approved" ? "Winner Selected!" : "Submission Rejected",
                message: status === "approved"
                    ? "You have selected a winner. They will be notified to claim their reward."
            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="mb-8">
                    ...
                    <p className="text-gray-500">
                        Bounty: <span className="font-semibold text-[#E4B95C]">{bounty?.title}</span>
                    </p>
                    <p className="text-sm text-gray-400 mt-1">
                        Validate submissions and select your winners.
                    </p>
                </div>
                ...
                {submissions.length === 0 ? (
                    ...
                    <div className="space-y-6">
                      ...
                      ${submission.status === 'approved' ? 'bg-green-100 text-green-700' :
                                            ...
                                            {submission.status === 'approved' ? 'Winner' : submission.status}
                                        </span>
                                    </div>
                                ...
                                <div className="flex flex-row md:flex-col gap-3 justify-center md:border-l md:pl-6 border-gray-100 pt-4 md:pt-0">
                                    ...
                                    >
                                        <IoCheckmarkCircleOutline size={20} /> Select as Winner
                                    </Button>
                                    <Button
